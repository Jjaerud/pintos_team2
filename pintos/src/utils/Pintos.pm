...
#   LOADER => $LOADER_SIZE-byte string containing the /home/jk5249/pintos/src/threads/build/loader.binary
#   ARGS => ['arg 1', 'arg 2', ...]
sub assemble_disk {
    my (%args) = @_;
...
sub read_loader {
    my ($name) = @_;
    $name = find_file ("/home/jk5249/pintos/src/userprog/build/loader.bin") if !defined $name;
